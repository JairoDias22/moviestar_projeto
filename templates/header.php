...
<?php if(!empty($flashMessage["msg"])): ?>
  <div class="msg-container container-fluid text-center p-3">
    <p class="msg <?= $flashMessage["type"] ?> m-0"><?= $flashMessage["msg"] ?></p>
  </div>
  <?php $message->clearMessage(); // Limpa mensagem ?>
<?php endif; ?>
...
<nav id="main-navbar">
  ...
  <form action="<?= $BASE_URL ?>search.php" method="GET" id="search-form">
    <input type="text" name="q" id="search" placeholder="Buscar Filmes">
  ...
  <ul class="navbar-nav">
  <?php if($userData): ?>
    <li class="nav-item"><a href="<?= $BASE_URL ?>newmovie.php" class="nav-link"><i class="bi bi-plus-square"></i>Incluir Filme</a></li>
